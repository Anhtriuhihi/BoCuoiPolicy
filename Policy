...
<p>BocuoiDev built the Chào Lớp 1 app as a free app. This SERVICE is provided by BocuoiDev [at no cost] and is intended
    for use as is.</p>
...
<p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions,
    which is accessible at Chào Lớp 1, unless otherwise defined in this Privacy Policy.</p>
